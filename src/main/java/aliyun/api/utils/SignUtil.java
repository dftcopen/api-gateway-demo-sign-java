...
public class SignUtil {
     ...
     * @param querys 请求queryString参数
     * @param bodys 请求body参数
     * @param signHeaderPrefixList 需要签名的header
     * @return 签名的URL
     */
    ...
    private static String buildHeaders(Map<String, String> headers, List<String> signHeaderPrefixList) {
    	...
    	if (null != signHeaderPrefixList) {
    		signHeaderPrefixList.remove(SystemHeader.X_CA_SIGNATURE.name());
    		...
    		if (null != headers) {
    			...
    			headers.put(SystemHeader.X_CA_SIGNATURE_HEADERS.getHeaderName(), signHeadersStringBuilder.toString());
    		}
    	}
